...
/**
 * 
 * Lists the calls that mesos can make to this client. Not all of them are
 * "callbacks" but you can rather see them as incoming data.
 * 
 * Documentation on the api is copied from here:
